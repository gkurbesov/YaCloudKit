...
namespace YaCloudKit.MQ.Tests
{
    ...
    {
        public const string TestKey = "key1";
        public const string TestKey2 = "key2";
        public const string TestValue = "value123";
        public const string TestValue2 = "value456";
        ...
        public void MessageAttributes_StringType_RequestParametersContainsCorrectData()
        {
            ...
            Assert.True(context.RequestParameters.TryGetValue("MessageAttribute.1.Value.StringValue", out var dataValue));
        ...
        public void MessageAttributes_BinaryType_RequestParametersContainsCorrectData()
        {
            ...
            Assert.True(context.RequestParameters.TryGetValue("MessageAttribute.1.Value.BinaryValue", out var base64Value));
        ...
        public void MessageAttributesBatchEntry_StringType_RequestParametersContainsCorrectData()
        {
            ...
            Assert.True(context.RequestParameters.TryGetValue($"SendMessageBatchRequestEntry.{entryNumber}.MessageAttribute.1.Name", out var keyValue1));
            Assert.Equal(TestKey, keyValue1);

            Assert.True(context.RequestParameters.TryGetValue($"SendMessageBatchRequestEntry.{entryNumber}.MessageAttribute.1.Value.DataType", out var dataType));
            Assert.Equal(AttributeValueType.String.ToString(), dataType);

            Assert.True(context.RequestParameters.TryGetValue($"SendMessageBatchRequestEntry.{entryNumber}.MessageAttribute.1.Value.StringValue", out var dataValue));
            Assert.Equal(TestValue, dataValue);
        }
        ...
        public void MessageAttributesBatchEntry_BinaryType_RequestParametersContainsCorrectData()
        {
            ...
            Assert.True(context.RequestParameters.TryGetValue($"SendMessageBatchRequestEntry.{entryNumber}.MessageAttribute.1.Value.BinaryValue", out var base64Value));
            Assert.NotEmpty(base64Value);
